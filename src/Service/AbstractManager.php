...
abstract class AbstractManager implements ManagerInterface
{
    ...
    protected static function getPDO()
    {
        if(self::$pdo === null){
            self::$pdo = new PDO(
                ...
                DB_PASS,
                [
                    PDO::ATTR_ERRMODE            => PDO::ERRMODE_EXCEPTION, //les erreurs venant de MySQL seront des Exceptions
    ...
    protected function fetchAssociation($sql): false|string
    {
        self::getPDO();
    ...
    protected function getResults($class, $sql, $params = null): array
    {
