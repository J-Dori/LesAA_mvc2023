...
<div class="container" id="admin-about-form">
    <div class="text-center">
        <h3 class="text-uppercase text-muted">Formulaire Parcours</h3>
    ...
    <div class="col-lg-10 col-12 mx-auto p-lg-5 p-3 border-light shadow">
        <form action="?ctrl=aboutAdmin&action=form<?= $editMode ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mb-5">
                ...
                <input type="text" class="form-control" name="title" maxlength="50" id="title" value="<?= $title ?>" placeholder="Titre : La team s'agrandie" required>
            </div>
            ...
            <div class="form-group d-inline-flex justify-content-start align-items-center flex-wrap flex-lg-nowrap">
                <div class="col-lg-2 col-md-4 col-12 me-md-3 mb-3 mb-md-0 text-center mx-auto">
                    <img class="card-img-top w-100 h-auto shadow" style="max-width: 125px" src="<?= CommonFunctions::fileExists(IMG_ABOUT, $imgPath) ?>" alt="Photo Parcours">
                </div>
