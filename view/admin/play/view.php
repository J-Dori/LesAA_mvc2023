...
<!-- Play Preview -->
<div class="container" id="admin-play-view">
    <div class="row d-flex justify-content-between align-items-center">
        <div class="col-12 col-lg-4 d-flex justify-content-between">
                <a class="btn btn-dark rounded-2 px-3 py-2" href="?ctrl=playAdmin&action=form&id=<?= $play->getId() ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                <a class="btn btn-secondary rounded-2 px-3 py-2 px-lg-5" href="?ctrl=playAdmin&action=index">Liste des Pièces</a>
                <a class="btn btn-danger rounded-2 px-3 py-2" href="?ctrl=playAdmin&action=delete&id=<?= $play->getId() ?>"><i class="fa-solid fa-trash-can"></i></a>
        </div>
        <div class="col-12 col-lg-8 mt-3 mt-lg-0 d-flex flex-wrap flex-lg-nowrap justify-content-lg-end justify-content-center gap-3">
                <a class="btn btn-dark rounded-2 px-3 py-2 w-md-100" href="?ctrl=actorAdmin&action=index">Comédiens</a>
                <a class="btn btn-dark rounded-2 px-3 py-2 w-md-100" href="?ctrl=playRolesAdmin&action=form&id=<?= $play->getId() ?>">Rôles</a>
        </div>
    </div>
    <hr class="my-3 p-0">
    <div class="row text-center">
        <div class="col-12 col-lg-4 mx-auto" style="max-width: 500px;">
            <img class="shadow w-100 h-auto"  src="<?= CommonFunctions::fileExists(IMG_PLAY_FLYERS, $play->getImgPath()) ?>" alt="Pièce" />
        ...
        <div class="col-12 col-lg-8 mt-5 mt-lg-0">
            ...
            <?php if ($play->getPlayStatusTitle() == 'En Scène' || $play->getDateStartMinus30Days()) { ?>
                <div class="col-12 text-center mx-auto">
                    ...
                    <?php } ?>
                    <span class="btn btn-secondary rounded mt-3 px-5 py-3 shadow">E-mail / Téléphone</span>
                </div>
            <?php } ?>
        </div>
    </div>
...
<?php
    if (!empty($playRoles)) {
        include VIEW_PATH . 'home/play/modal_play_roles.php';
    }
} ?>
