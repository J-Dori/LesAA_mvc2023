<?php
    ...
    //$play and $playRoles : response data from play/view.php
?>

<div id="modalPlayRoles" class="modal fade" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title">Liste des Rôles</h5>
                <?php if (Session::isAdmin()) { ?>
                    <a href="<?= '?ctrl=playRoles&play=' . $play->getId() ?>" title="Gestion des Rôles">
            ...
            <div class="modal-body">
                <table class="table table-striped">
                    <thead class="border-1 text-muted">
                        <tr>
                            <th class="p-2 text-muted">Comédien(ne)</th>
                    ...
                    <tr>
                        <td colspan="2" class="text-center">Aucun rôle enregistré</td>
                    </tr>
                    <?php } else {
                        foreach ($playRoles as $role) {
                    ?>
            ...
            <div class="modal-footer border-top-0">
                <button id="modalPlayRolesCloseBtn" type="button" class="btn btn-secondary px-5 py-2" data-bs-dismiss="modal">Fermer</button>
            </div>
        </div>
    </div>
</div>
